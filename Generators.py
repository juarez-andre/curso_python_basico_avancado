...
print(nome[0] == 'C' for nome in nomes)     # Lembrando que retorna um generator object
...
# Eu posso iterar em um generator object? Sim! Assim como também posso iterar em map object e filter object.
(Sem necessariamente transformá-los em uma tupla, lista etc.)
