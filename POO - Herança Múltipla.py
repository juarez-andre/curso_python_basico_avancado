...
a classe filha herde todos os atributos de todas as classes herdadas.

OBS: A herança pode ser feita de duas maneiras:
...
print(tux.andar())
print(tux.nadar())
print(tux.cumprimentar())   # Eu sou Tux da terra - Pois terrestre vem antes de Aquatico na declaração da classe Pinguim
