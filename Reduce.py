...
A função reduce() funciona da seguinte forma:
    ...
    Passo 2: res2 = f(res1, a3) # Aplica a função passando o resultado do passo 1 + o terceiro elemento e guarda o resultado.
    # Isso é repetido até o final
    Passo 3: res 3 = f(res2, a4)
    .
    .
    .
...
# Para utlizar o reduce() nós precisamos de uma função que receba dois parâmetros
