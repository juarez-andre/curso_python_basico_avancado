...
# writer() -> Gera um objeto para que possamos escrever em um arquivo CSV. Utilizamos o método writerow() para escrever cada linha. Este módulo recebe uma lista.
...
with open('filmes2.csv', 'w') as arquivo:
    cabeçalho = ['Título', 'Gênero', 'Duração']
